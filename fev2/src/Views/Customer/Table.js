...
import { GetListCustomer,GetCustomerById  } from '../../services/Customer'
...
export default function DenseTable() {
    ...
    useEffect(() => {
        async function fetchListCustomers() {
            const customers = (await GetListCustomer()).data
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                <TableBody>
                    {listCustomers.map((row) => (
                        ...
                        >
                            <TableCell component="th" scope="row">{row.MAKH}</TableCell>
